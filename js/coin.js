...
(function () {
    ...
    coinjs.getPublic = function(coinid,accountid,addressid) {
        coinjs.comm.create_async(0, true).then(function(comm) {
            ...
            var tx1 = btc.splitTransaction("", 1);

            btc.signP2SHTransaction_async([ [tx1, 1, "522102db4d785e65d6082f430b90577b1ab69b8db789be00a94bf81ec49f38fc77c0884104131f4fb6fdc603ad3859c2c5b3f246f1ee3ba5391600e960b9be4c59f609b3dd320b38ef7cae98f1debb622db01f37087a3bd05e266d73e43631ee18b45a484552ae"] ], [path], "522102db4d785e65d6082f430b90577b1ab69b8db789be00a94bf81ec49f38fc77c0884104131f4fb6fdc603ad3859c2c5b3f246f1ee3ba5391600e960b9be4c59f609b3dd320b38ef7cae98f1debb622db01f37087a3bd05e266d73e43631ee18b45a484552ae", undefined, undefined, 1).then(function(result) {
                console.log(result);
    ...
    coinjs.getPublicBTC = function(coinid,accountid,addressid) {
        coinjs.comm.create_async(0, true).then(function(comm) {
            ...
            btc.signP2SHTransaction_async([ [tx1, 1, "52210289b4a3ad52a919abd2bdd6920d8a6879b1e788c38aa76f0440a6f32a9f1996d02103a3393b1439d1693b063482c04bd40142db97bdf139eedd1b51ffb7070a37eac321030b9a409a1e476b0d5d17b804fcdb81cf30f9b99c6f3ae1178206e08bc500639853ae"] ], ["0'/0/0"], "01905f0100000000001976a91472a5d75c8d2d0565b656a5232703b167d50d5a2b88ac").then(function(result) {
                console.log(result);
            }).fail(function(ex) {console.log(ex);});
